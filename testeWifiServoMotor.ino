...
char ssid[] = "ALHN-0889"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO
char pass[] = "8434738152";//VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO
...
void setup(){
  ...
  WiFi.config(IPAddress(192,168,1,222)); //COLOQUE UMA FAIXA DE IP DISPONÍVEL DO SEU ROTEADOR
